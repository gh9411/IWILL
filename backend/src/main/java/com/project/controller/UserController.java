...
public class UserController {
    ...
    @ApiOperation(value = "회원가입", note = "회원 가입 입니다.")
    @ApiImplicitParams({
    ...
    @ApiOperation(value = "회원 정보", note = "회원 정보 조회 입니다.")
    ...
    @ApiOperation(value = "회원 정보 수정", note ="회원 정보 수정 입니다.")
    public void update(@Valid @RequestParam int uid){
        ;
    }

    @PostMapping("/user/delete")
    @ApiOperation(value = "회원 탈퇴", note = "회원 탈퇴 입니다.")
    public void delete(@Valid @RequestParam int uid){
        ;
    }

    @PostMapping("/user/findPw")
    @ApiOperation(value = "비밀번호 찾기", note = "비밀번호 찾기 입니다.")
